...
可选地，它可以监视自定义[参数](/v0.17/docs/reference/kueue.v1beta1/#kueue-x-k8s-io-v1beta1-AdmissionCheckParametersReference)对象。

[资源调配准入检查控制器](/v0.17/docs/admission-check-controllers/provisioning/)在
