...
{{< include "v0.18/examples/pod-based-workloads/workflow-single-queue.yaml" "yaml" >}}
...
{{< include "v0.18/examples/pod-based-workloads/workflow-queue-per-template.yaml" "yaml" >}}
