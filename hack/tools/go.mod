...
require (
	...
	k8s.io/code-generator v0.35.6 // Used not only as code-generator but also for compatibility_lifecycle (feature-gates docs) tool versioning.
...
require (
	...
	k8s.io/metrics v0.35.6 // indirect
